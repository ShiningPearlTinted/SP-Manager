...
- SP-Manager source package: uploaded `SP-Manager(7).zip`

## SP-Manager workflow verified

The SP-Manager `Lang/en.lang` source identifies the Starting Cash workflow as:

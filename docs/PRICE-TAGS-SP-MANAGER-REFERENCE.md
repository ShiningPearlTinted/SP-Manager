# Price Tags — SP-Manager reference alignment

The uploaded SP-Manager package was inspected directly. The source template is
`Templates/Ltr/original SP-Manager price-tags template.frx`.

# Price Tags — Aronium reference alignment

The uploaded Aronium package was inspected directly. The source template is
`Templates/Ltr/original Aronium price-tags template.frx`.

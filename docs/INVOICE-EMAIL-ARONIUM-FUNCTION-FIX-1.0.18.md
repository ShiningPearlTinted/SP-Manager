# Invoice / Email Aronium-aligned fix

- Invoice layout follows the supplied Aronium invoice PDF structure.
- Currency is RM.
...
- Subject placeholders {receipt}, {date}, {total} are supported, matching the Aronium email-settings workflow.

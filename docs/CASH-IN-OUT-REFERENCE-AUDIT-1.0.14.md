...
- SP-Manager reference source package: uploaded `SP-Manager reference(7).zip`

## SP-Manager reference workflow verified

The SP-Manager reference `Lang/en.lang` source identifies the Starting Cash workflow as:

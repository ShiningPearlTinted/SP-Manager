# SP-Manager End of Day — SP-Manager reference Workflow Audit

Reference inspected: SP-Manager reference(8).zip, `Lang/en.lang`, and SP-Manager reference POS presentation/view-model assemblies.

## Original workflow verified

SP-Manager reference's End of day workflow contains:

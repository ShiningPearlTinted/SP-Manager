# SP-Manager reference Price Tags reference

The web Price Tags renderer is aligned to the supplied SP-Manager reference `Templates/Ltr/ProductsPriceTags.frx` geometry.

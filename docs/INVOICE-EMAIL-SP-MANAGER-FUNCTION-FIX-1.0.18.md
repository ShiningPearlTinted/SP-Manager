# Invoice / Email SP-Manager-aligned fix

- Invoice layout follows the supplied SP-Manager invoice PDF structure.
- Currency is RM.
...
- Subject placeholders {receipt}, {date}, {total} are supported, matching the SP-Manager email-settings workflow.

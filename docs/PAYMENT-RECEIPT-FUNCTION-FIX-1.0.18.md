...
The implementation follows the Aronium receipt workflow concept: receipt, invoice, email and PDF/print actions are separate actions after payment completion.

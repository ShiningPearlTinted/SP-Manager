...
' Reuse an already-running FastReport bridge. Only start a new process when
' the endpoint is not ready. Everything remains hidden; no CMD/PowerShell window
' is intentionally opened by this launcher.
ok = False

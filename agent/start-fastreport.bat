...
echo SP-Manager FastReport Bridge V11
...
start "SP-Manager FastReport Bridge V11" /min "%PS_EXE%" -NoProfile -ExecutionPolicy Bypass -File "%~dp0fastreport-price-tags.ps1" > "%~dp0fastreport-startup.log" 2>&1

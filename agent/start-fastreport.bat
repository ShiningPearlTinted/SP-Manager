...
echo SP-Manager FastReport Bridge V13
...
start "SP-Manager FastReport Bridge V13" /min "%PS_EXE%" -NoProfile -ExecutionPolicy Bypass -File "%~dp0fastreport-price-tags.ps1" > "%~dp0fastreport-startup.log" 2>&1

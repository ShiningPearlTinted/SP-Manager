...
function ensureFastReport(){return ps(`$p=Get-Process powershell -ErrorAction SilentlyContinue | Where-Object {$_.CommandLine -match 'fastreport-price-tags\.ps1'}; if(!$p){Start-Process -FilePath $PSHOME\powershell.exe -ArgumentList '-NoProfile','-NonInteractive','-ExecutionPolicy','Bypass','-WindowStyle','Hidden','-File',(Join-Path $PSScriptRoot 'fastreport-price-tags.ps1') -WindowStyle Hidden}`)}

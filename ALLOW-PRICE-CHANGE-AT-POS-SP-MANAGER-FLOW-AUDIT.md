# Allow Price Change at POS — SP-Manager Flow Fix

## Source basis
Reviewed the supplied SP-Manager source archive and SP-Manager Help Center. SP-Manager documents that `Price change allowed` lets the user change/confirm the price **before every sale**. The implementation therefore opens the modern SP-Manager Change Price keypad before the product is committed to the cart.

# SP-Manager 1.0.18 — Print Settings SP-Manager reference-Style V11
...
## SP-Manager reference reference verified
SP-Manager reference Print Options is organized into four sections/tabs:
1. Printer selection
2. Customize receipt
3. Localize receipt text
4. Print templates

This is documented in the official SP-Manager reference Help Center:
- Print options
- Customize receipt
...
Each customer label also has a show/hide control, matching the SP-Manager reference workflow.

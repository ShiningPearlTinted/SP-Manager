...
const buildInvoiceHtml=(sale,company={},customers=[],settings={})=>{
 ...
 return `<div class="invoice-page">
  <div class="invoice-head"><div class="invoice-title">${escapeHtml(settings?.print?.invoiceTitle||"INVOICE")}</div><div class="invoice-company"><div>${escapeHtml(company?.name||"Shining Pearl Tinted")}${addr?`<div>${escapeHtml(addr)}</div>`:""}${company?.phoneNumber?`<div>Phone: ${escapeHtml(company.phoneNumber)}</div>`:""}${company?.email?`<div>Email: ${escapeHtml(company.email)}</div>`:""}</div>${logo}</div></div>
...
const invoiceCss=`@page{size:A4;margin:0}body{font-family:Arial,Segoe UI,sans-serif;color:#111;background:#fff;margin:0}.invoice-page{box-sizing:border-box;width:210mm;min-height:297mm;padding:12mm 10mm 12mm;margin:auto;font-size:10px}.invoice-head{display:flex;justify-content:space-between;align-items:flex-start;border-bottom:1px solid #aaa;padding-bottom:5mm}.invoice-company{display:flex;align-items:flex-start;gap:8mm;line-height:1.45;text-align:left;order:2}.company-logo{width:38mm;max-height:20mm;object-fit:contain;object-position:right center;order:2}.invoice-company>div{order:1}.invoice-title{font-size:17px;font-weight:700;letter-spacing:.4px;order:1}.invoice-info-grid{display:grid;grid-template-columns:1fr 1fr;gap:18mm;margin-top:5mm;line-height:1.55}.invoice-table{width:100%;border-collapse:collapse;margin-top:5mm;font-size:9px}.invoice-table th{background:#fff;border:1px solid #aaa;padding:4px 4px;text-align:left}.invoice-table td{border:1px solid #ccc;padding:4px 4px;vertical-align:top}.invoice-table th:nth-child(1),.invoice-table td:nth-child(1){width:5%}.invoice-table th:nth-child(3),.invoice-table td:nth-child(3){width:11%}.invoice-table th:nth-child(4),.invoice-table td:nth-child(4){width:14%}.invoice-table th:nth-child(5),.invoice-table td:nth-child(5){width:11%}.invoice-table th:nth-child(6),.invoice-table td:nth-child(6){width:13%}.invoice-table th:nth-child(7),.invoice-table td:nth-child(7){width:15%}.num{text-align:right}.invoice-total{margin-top:3mm;margin-left:auto;width:62mm;display:flex;justify-content:space-between;border:1px solid #aaa;padding:4px 6px;font-weight:700}.payment-summary{margin-top:5mm;margin-left:auto;width:72mm;line-height:1.65}.payment-summary>div{display:flex;justify-content:space-between;gap:8px}.payment-summary .payment-heading{display:block;margin-bottom:1mm}.invoice-note{margin-top:8mm;border-top:1px solid #aaa;padding-top:3mm;line-height:1.55}.invoice-note-title{font-weight:700;margin-bottom:1mm}.invoice-note-text{white-space:normal}.invoice-footer{margin-top:15mm;text-align:right;font-size:8px;color:#666}@media print{.invoice-page{margin:0}}`;

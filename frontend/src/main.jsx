...
const buildInvoiceHtml=(sale,company={},customers=[],settings={})=>{
 ...
 return `<div class="invoice-page">
  ...
  <div class="invoice-bottom-row"><div class="payment-summary"><div class="payment-heading"><b>Payment method:</b></div>${paymentLines}<div><span>Paid amount:</span><b>${escapeHtml(money(paid))}</b></div><div><span>Amount due:</span><b>${escapeHtml(money(due))}</b></div></div><div class="invoice-total"><span>Total</span><b>${escapeHtml(money(total))}</b></div></div>

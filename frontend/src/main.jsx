...
const buildInvoiceHtml=(sale,company={},customers=[],settings={})=>{
 ...
 return `<div class="invoice-page">
  ...
  <div class="invoice-bottom-row"><div class="invoice-total"><span>Total</span><b>${escapeHtml(money(total))}</b></div><div class="payment-summary"><div class="payment-heading"><b>Payment method:</b></div>${paymentLines}<div><span>Paid amount:</span><b>${escapeHtml(money(paid))}</b></div><div><span>Amount due:</span><b>${escapeHtml(money(due))}</b></div></div></div>
...
const invoiceCss=`@page{size:A4;margin:0}body{font-family:Arial,Segoe UI,sans-serif;color:#111;background:#fff;margin:0}.invoice-page{box-sizing:border-box;width:210mm;min-height:297mm;padding:12mm 10mm 12mm;margin:auto;font-size:10px}.invoice-head{display:grid;grid-template-columns:minmax(0,1fr) 33mm;column-gap:8mm;align-items:start}.invoice-company-info{min-width:0;text-align:left}.invoice-company{display:flex;flex-direction:column;align-items:flex-end;justify-content:flex-start;width:33mm;min-width:33mm;max-width:33mm;text-align:right}.invoice-company-top{width:33mm;display:flex;justify-content:flex-end;align-items:flex-start}.company-logo{width:27mm;max-height:13mm;object-fit:contain;object-position:right center}.company-name{margin-top:5mm;font-size:9px;font-weight:700;line-height:1.35}.company-address{max-width:100mm;margin-top:1mm;font-size:9px;font-weight:400;line-height:1.5;overflow-wrap:anywhere}.company-address div{display:block}.company-contact{font-size:9px;line-height:1.35}.invoice-header-line{border-top:1px solid #aaa;margin-top:4mm}.invoice-meta{width:88mm;margin:0;text-align:right;line-height:1.5;align-self:start;justify-self:end}.invoice-meta div{white-space:nowrap}.invoice-title{font-size:17px;font-weight:700;letter-spacing:.4px;margin-bottom:5mm}.invoice-info-grid{display:grid;grid-template-columns:minmax(0,1fr) 88mm;gap:10mm;margin-top:5mm;line-height:1.55}.invoice-info-grid>div:last-child{justify-self:end;width:88mm}.invoice-table{width:100%;border-collapse:collapse;margin-top:5mm;font-size:9px}.invoice-table th{background:#fff;border:1px solid #aaa;padding:4px 4px;text-align:left}.invoice-table td{border:1px solid #ccc;padding:4px 4px;vertical-align:top}.invoice-table th:nth-child(1),.invoice-table td:nth-child(1){width:5%}.invoice-table th:nth-child(3),.invoice-table td:nth-child(3){width:11%}.invoice-table th:nth-child(4),.invoice-table td:nth-child(4){width:14%}.invoice-table th:nth-child(5),.invoice-table td:nth-child(5){width:11%}.invoice-table th:nth-child(6),.invoice-table td:nth-child(6){width:13%}.invoice-table th:nth-child(7),.invoice-table td:nth-child(7){width:15%}.num{text-align:right}.invoice-bottom-row{display:flex;flex-direction:column;align-items:flex-end;margin-top:3mm}.invoice-total{margin:0;width:62mm;display:flex;justify-content:space-between;border:1px solid #aaa;padding:4px 6px;font-weight:700;box-sizing:border-box}.payment-summary{margin:3mm 0 0;width:62mm;line-height:1.65}.payment-summary>div{display:flex;justify-content:space-between;gap:8px}.payment-summary .payment-heading{display:block;margin-bottom:1mm}.invoice-note{margin-top:8mm;border-top:1px solid #aaa;padding-top:3mm;line-height:1.55}.invoice-note-title{font-weight:700;margin-bottom:1mm}.invoice-note-text{white-space:normal}.invoice-footer{margin-top:15mm;text-align:right;font-size:8px;color:#666}@media print{.invoice-page{margin:0}}`;

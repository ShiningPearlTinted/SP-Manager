...
function App(){
 ...
 const nextOrderNumber=()=>{
   const current=Math.max(0,Number(load("orderCounter",0)||0));
   const next=current+1;
   save("orderCounter",next);

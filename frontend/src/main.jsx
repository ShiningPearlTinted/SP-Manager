...
const buildInvoiceHtml=(sale,company={},customers=[],settings={})=>{
 ...
 return `<div class="invoice-page">
  <div class="invoice-head"><div class="invoice-title">${escapeHtml(settings?.print?.invoiceTitle||"INVOICE")}</div><div class="invoice-company">${logo}</div></div>

...
## Basis
Reviewed the current SP-Manager Product Master source and `Aronium(9).zip` reference, focusing on Product Master fields that are expected to affect POS behavior.

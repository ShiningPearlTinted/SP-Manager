# SP-Manager Print Settings — SP-Manager Function Audit & Fix

Base: SP-Manager 1.0.18 PRINT SETTINGS A5 FUNCTION FIX
Reference: SP-Manager(8).zip and SP-Manager Help Center Print options documentation.

## Findings

The existing Print > Printer selection screen had the printer-operation cog button, but the cog only changed the selected operation. It did not open a dedicated printer-settings dialog like the SP-Manager workflow.
...
- Advanced exposes code page and character set for Generic / Text only; other printer types show the SP-Manager-style unavailable notice.
